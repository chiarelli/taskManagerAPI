...
public class TarefaAlteradaEvent extends AbstractDomainEvent<TarefaAlteradaEvent.Payload> {

  public TarefaAlteradaEvent(Projeto projeto, Payload payload) {
    super(projeto, payload);
  }

  public static record Payload(TarefaId tarefaId, String titulo, String descricao, DataVencimentoVO dataVencimento, 
